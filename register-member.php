        ...
        <form action="register-process.php" method="post">
            <div class="user-details">
                <div class="input-box">
                    ...
                    <!-- Added name="email" and type="email" for proper email validation -->
                    <input type="email" name="email" placeholder="Enter your email" required>
                </div>
                <div class="input-box">
                    <span class="details">Phone Number</span>
                    <!-- Added name="phone" and type="tel" for phone number input -->
                    <input type="tel" name="phone" placeholder="Enter your number" required pattern="[0-9]{10}">
                </div>
                <div class="input-box">
                    <span class="details">Password</span>
                    <!-- Changed to type="password" and added name="password" -->
                    <input type="password" name="password" placeholder="Enter your password" required minlength="8">
                </div>
                <div class="input-box">
                    <span class="details">Confirm Password</span>
                    <!-- Changed to type="password" and added name="cpassword" -->
                    <input type="password" name="cpassword" placeholder="Confirm your password" required minlength="8">
                </div>
            </div>
            <div class="button">
...
<script>
  // JavaScript for validating matching passwords
