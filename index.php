...
if (isset($_SESSION['success'])) {
    echo '<div class="alert alert-success">' . $_SESSION['success'] . 
         ' <a href="dashboard.php">Click Here to Continue</a></div>';
...
<div class="container">
	<div class="screen">
		...
		<form action="authenticate-member.php" method="post" class="login">
			...
			<div class="login__field">
				...
				<!-- Add name="password" to the password input -->
			...
			<div class="social-login">
                <a href="/view"><h3>Forgot Password?</h3></a>
