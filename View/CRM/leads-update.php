...
// Get the contact from the leads table
...
if (isset($_POST['submit'])) {
    ...
    if (!$error_msg) {
        ...
        $stmt->execute();
        // Get the updated contact from the leads table
        $stmt = $pdo->prepare('SELECT * FROM  ' . $Leads . ' WHERE id = ?');
        $stmt->execute([ $_GET['id'] ]);
        $contact = $stmt->fetch(PDO::FETCH_ASSOC);
        // Output message
    ...
    <div id="content">
        ...
        <div class=container-fluid>
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <div class="wrap">
                    <h1 class="h3 mb-0 text-gray-800">Update Leads Contact #<?=$contact['id']?></h1>
                </div>
            </div>
