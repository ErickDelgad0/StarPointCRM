...
if (isset($_GET['id'])) {
    ...
    if (isset($_GET['confirm'])) {
        if ($_GET['confirm'] == 'yes') {
            ...
            // User clicked the "No" button, redirect them back to the Admin page
    ...
    <div id="content">
        ...
        <div class= container-fluid>
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <div class="wrap">
                    <h1 class="h3 mb-0 text-gray-800">Delete Employee Contact #<?=$contact['id']?></h1>
                </div>
            </div>
